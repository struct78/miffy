...
class _View_TabsPage0 extends import1.AppView<import0.TabsPage> {
  ...
  createInternal(rootSelector:string):import3.AppElement {
    ...
    this.renderer.setElementAttribute(this._el_4,'tabIcon','settings');
    this.renderer.setElementAttribute(this._el_4,'tabTitle','Settings');
    ...
    this.renderer.setElementAttribute(this._el_6,'tabIcon','information-circle');
    this.renderer.setElementAttribute(this._el_6,'tabTitle','About');
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_12:any = 'information-circle';
